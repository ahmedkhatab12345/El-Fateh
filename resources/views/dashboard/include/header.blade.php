...
<img class="avatar rounded-circle" src="{{ url('/') }}/dashboard/assets/img/xs/avatar5.jpg" alt="">
...
<li class="py-2 mb-1 border-bottom">
<a href="javascript:void(0);" class="d-flex">
<img class="avatar rounded-circle" src="{{ url('/') }}/dashboard/assets/img/xs/avatar6.jpg" alt="">
<div class="flex-fill ms-3">
...
<li class="py-2 mb-1 border-bottom">
<a href="javascript:void(0);" class="d-flex">
<img class="avatar rounded-circle" src="{{ url('/') }}/dashboard/assets/img/xs/avatar1.jpg" alt="">
<div class="flex-fill ms-3">
...
<li class="py-2 mb-1 border-bottom">
<a href="javascript:void(0);" class="d-flex">
<img class="avatar rounded-circle" src="{{ url('/') }}/dashboard/assets/img/xs/avatar3.jpg" alt="">
<div class="flex-fill ms-3">
...
<li class="py-2 mb-1 border-bottom">
<a href="javascript:void(0);" class="d-flex">
<img class="avatar rounded-circle" src="{{ url('/') }}/dashboard/assets/img/xs/avatar4.jpg" alt="">
<div class="flex-fill ms-3">
...
<li class="py-2">
<a href="javascript:void(0);" class="d-flex">
<img class="avatar rounded-circle" src="{{ url('/') }}/dashboard/assets/img/xs/avatar7.jpg" alt="">
<div class="flex-fill ms-3">
...
<img class="avatar img-thumbnail rounded-circle shadow" src="{{ url('/') }}/dashboard/assets/img/profile_av.png" alt="">
</a>
<div class="dropdown-menu border-0 rounded-4 shadow p-0">
<div class="card border-0 w240">
<div class="card-body border-bottom d-flex">
<img class="avatar rounded-circle" src="{{ url('/') }}/dashboard/assets/img/profile_av.png" alt="">
<div class="flex-fill ms-3">
<h6 class="card-title mb-0">Allie Grater</h6>
<span class="text-muted"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="2f4e4343464a485d4e5b4a5d6f435a4140014c4042">[email&#160;protected]</a></span>
</div>
</div>
